...
That's Terasology interacting with our other game [Destination Sol](https://destinationsol.org/) — a completely independent game, a 2D space shooter without multiplayer. Player chat across game engines. Items being "beamed" between universes. A spaceship engine from DestSol showing up as an item in Terasology's inventory.
...
There has been this [whole AI thing going on in the world, for better or worse](https://siliconsaga.net/oss-communities-and-ai/). Behind the quiet there's been work on [development methodology (GDD) & workspace tooling](https://siliconsaga.net/guardian-driven-development/), and a massive [dependency injection refactor](https://github.com/MovingBlocks/Terasology/pull/5299) that's been in progress for two years finally merged at long last! The engine is evolving.
...
We're trying to get some momentum again right now. The DI migration is being cleaned up through systematic review with responsible AI assistance. The workspace tooling is maturing. And Bifrost has an absurd [roadmap](https://github.com/SiliconSaga/bifrost/blob/main/bifrost-protocol.md) meant to inspire, not direct.
