          ...
          <Col md="8">
            <Row className="mt-6e">
              <Col lg="5" className="pt-5">
                <Img 
                  fluid={data.historyImg.childImageSharp.fluid}
                  style={{ height: '100%' }}
          ...
          <Col md="8">
            <Row className="mt-6e">
              <Col lg="7" md={{ order:2 }}>
                ...
                <p className="text-justify">
                  Terasology's engine uses a whitelisting approach to expose an API for modules using two primary methods 
                  and a rarely needed third one:
                </p>
                <ul>
                  <li>Classes or packages marked with the @API annotation</li>
                  <li>Classes or packages in the basic whitelist defined in ExternalApiWhitelist.java</li>
                  <li>
                    Rarely blocks of code in the engine may be hit in a way requiring use of AccessController.doPrivileged(...) 
                    usually module authors do not need to worry about this but once in a while it could explain something quirky
                  </li>
                </ul>
                <div className="text-center">
                  <a className="font-weight-bold btn btn-lg btn-success mt-5" href="https://github.com/MovingBlocks/Terasology/wiki/Modding-API">Learn More</a>
                </div>
              </Col>
              <Col lg="5" md={{ order: 1 }} className="pt-5">
                <Img 
                  fluid={data.modding.childImageSharp.fluid}
                  style={{ height: '100%' }} 
                  alt="Terasology Modding API" />
              </Col>
            </Row>
          </Col>
        </Row>
