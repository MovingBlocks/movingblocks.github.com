          ...
          <Row className="justify-content-center">
            <div className="col-md-10">
              <div className="text-center  gsoc_tsoc_content">
                ...
                Every year more than 1200 students are accepted.
                ...
                about open source development while earning a stipend.
              ...
              <div className="text-center mt-4 gsoc_tsoc_content">
                ...
                is similar as Google Summer of Code (GSoC).
                It is sponsored by Terasology with different timeline then GSoC,
                do half of work, take a break for exams and other thing
                and then do second half work. Lower stipend than GSoC.
